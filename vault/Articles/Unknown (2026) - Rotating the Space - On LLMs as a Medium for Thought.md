---
title: "Rotating the Space: On LLMs as a Medium for Thought"
authors: ["Unknown"]
publisher: "rotating_the_space"
url: "https://sbgeoaiphd.github.io/rotating_the_space/"
type: "article"
status: "unread"
added: "2026-02-26"
tags:
  - large-language-models-as-medium
  - projection-space
  - iterative-exploration
  - artifact-vs-thinking
  - dimensionality-reduction
  - human-ai-collaboration
  - cognitive-tool
  - epistemic-frames
  - embodied-metaphor
  - native-media-possibility
---
...
**Source:** [rotating_the_space](https://sbgeoaiphd.github.io/rotating_the_space/)

> [!quote] Memorable Quote
> "The LLM is similar. It has opinions—statistical ones, derived from training, but still shaping what it generates. When you engage with it iteratively, you're not just prompting and receiving. You're co-exploring."

## Quick Refresh

This paper reframes large language models not as content generators or search engines, but as a new medium for iterative thinking—what the author calls "rotating through projection-space." Rather than asking LLMs to produce finished artifacts, the paper argues that their native capability is enabling rapid exploration of the same concept from multiple angles: as metaphors, counter-arguments, simplified explanations, or entirely different rhetorical framings. The paper positions this as analogous to how film and photography revealed native possibilities beyond their predecessors, and argues that most discourse about LLMs misses this possibility entirely because it remains focused on output quality and authenticity debates.

## Why You Cared

You care about understanding LLMs beyond the hype and dismissal narratives that dominate public discourse. This paper offers a genuinely novel frame—treating language models as thinking-partners rather than automated workers—that explains why some people find them genuinely transformative while others dismiss them as mediocre text generators. If you use LLMs iteratively and reflectively rather than as a one-shot question-answering tool, this paper articulates what you might intuitively sense: that the real value lies in the dialogue and exploration, not the final output. The paper also models its own argument through its authorship structure, demonstrating the collaborative thinking-process it describes.

## Key Concepts

`#large-language-models-as-medium` `#projection-space` `#iterative-exploration` `#artifact-vs-thinking` `#dimensionality-reduction` `#human-ai-collaboration` `#cognitive-tool` `#epistemic-frames` `#embodied-metaphor` `#native-media-possibility`
...
# [rotating\_the\_space](https://sbgeoaiphd.github.io/rotating_the_space/)
