...
5. Belinkov Y. (2022). Probing classifiers: Promises, shortcomings, and advances. Computational Linguistics, Vol. 48(1), pp. 207-219.
...
13. Buzsáki G. & Llinás R. (2017). Space and time in the brain. Science, Vol. 358(6362), pp. 482-485.
...
18. Goh G., Cammarata N., Voss C. et al. (2021). Multimodal neurons in artificial neural networks. Distill, Vol. 6(3), pp. 30.
...
21. Hafting T., Fyhn M., Molden S. et al. (2005). Microstructure of a spatial map in the entorhinal cortex. Nature, Vol. 436(7052), pp. 801-806.
...
32. Max M., Louwerse N. & Benesh (2012). Representing spatial structure through maps and language: Lord of the rings encodes the spatial structure of middle earth. Cognitive science, Vol. 36(8), pp. 1556-1569.
33. Max M., Louwerse R. A. & Zwaan (2009). Language encodes geographical information. Cognitive Science, Vol. 33(1), pp. 51-73.
34. Meng K., Bau D., Andonian A. et al. (2022). Locating and editing factual associations in gpt. Advances in Neural Information Processing Systems, Vol. 35, pp. 17359-17372.
...
37. Mikolov T., Sutskever I., Chen K. et al. (2013). Distributed representations of words and phrases and their compositionality. Advances in neural information processing systems, Vol. 26.
...
42. John O., Keefe J. & Dostrovsky (1971). The hippocampus as a spatial map: preliminary evidence from unit activity in the freely-moving rat. Brain research.
43. Olah C., Cammarata N., Schubert L. et al. (2020). Zoom in: An introduction to circuits. Distill, Vol. 5(3), pp. 24-25.
...
47. Rogers A., Kovaleva O. & Rumshisky A. (2021). A primer in bertology: What we know about how bert works. Transactions of the Association for Computational Linguistics, Vol. 8, pp. 842-866.
